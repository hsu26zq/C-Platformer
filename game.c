/*THIS CODE IS MY OWN WORK. IT WAS WRITTEN WITHOUT CONSULTING CODE WRITTEN BY OTHER STUDENTS OR ANY ONE WHO IS NOT AWARE OF MY REFERENCE. 409430012徐名威 409430001李濬承*/
#include<stdio.h>
#include<stdlib.h>
#include<math.h>
#include<time.h>
...
void draw_bg_color_ini(int current_y[],int y[],int *X,int mode)
{
	for(int i=0;i<width;i++)//從每一欄開始，一欄結束換下一欄 i:x j:y;
	{
